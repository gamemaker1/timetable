...
export const Templates = {
  ...
  friend: (friend, isOpen, courses) => `
    <div class="relative friend-container pt-4 border-t border-slate-100 dark:border-slate-800" data-id="${friend.id}">
      <div class="flex items-center justify-between group mb-2">
        <div class="flex items-center gap-3">
          ...
          <span class="text-[14px] font-medium text-slate-900 dark:text-slate-100 cursor-pointer action-search">${escape(friend.name)}</span>
        </div>
